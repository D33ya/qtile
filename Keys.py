from libqtile.config import Key, Click, Drag, ScratchPad, DropDown
...
keys = [
    ...
    Key([mod], 'o', lazy.group['scratchpad'].dropdown_toggle('python')),
    Key([mod], 'p', lazy.group['scratchpad'].dropdown_toggle('btop')),
